...
const CapsuleDesignSelector = ({ value, onChange }) => {
    ...
    const designs = [
        {
            id: 'heritage',
            name: t('heritageAlbum'),
            description: t('heritageAlbumDescription'),
        ...
        {
            id: 'chronicle',
            name: t('digitalChronicle'),
            description: t('digitalChronicleDescription'),
        ...
        {
            id: 'legacy',
            name: t('romanticJournal'),
            description: t('romanticJournalDescription'),
        ...
        },
        {
            id: 'vault',
            name: t('crystalVault'),
            description: t('crystalVaultDescription'),
