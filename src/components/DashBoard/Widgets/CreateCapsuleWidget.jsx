...
const CreateCapsuleWidget = () => {
    ...
    return (
        <div className='bg-accent/10 backdrop-blur-lg p-5 rounded-2xl shadow-secondary h-full flex flex-col border border-accent/30 relative overflow-hidden'>
            ...
            <a href={"/CapsuleCreation"} className="flex mt-auto">
                <button
                    className='bg-gradient-to-r from-button to-btnOutline text-background font-bold py-2.5 rounded-full w-full mt-auto border border-button/50 shadow-secondary flex items-center justify-center space-x-2 hover:from-button hover:to-button transition-all duration-300'>
