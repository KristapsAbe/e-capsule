                      ...
                      <div className="relative w-full h-full overflow-hidden">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/50 p-4">
                          ...
                          <p className="text-center text-white font-medium">
                            {formData.images.length} {formData.images.length === 1 ? t('photo') : t('photos')} {t('sealedInThisMemory')}
                          </p>
                          {hasMessage && (
        ...
        >
          ...
          <div className={`p-4 backdrop-blur-md ${styles.header} border-b border-white/20`}>
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-xl font-bold truncate">{formData.title || t('untitledCapsule')}</h2>
            </div>
          </div>
            ...
            <div className="relative mt-2">
              <div className={`flex items-center gap-2 text-base font-medium text-center justify-center 
                ...
                {isReady ? (
                    ...
                    <>
                      <Clock size={18} style={{ color: styles.accent }} />
                      <span className="relative z-10">{t('opensIn').replace('{days}', daysUntilOpen)}</span>
                    </>
                )}
              </div>
            </div>
